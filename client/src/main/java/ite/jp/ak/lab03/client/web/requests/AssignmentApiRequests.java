...
public class AssignmentApiRequests {
    ...
    public static AssignmentDto getAssignmentBySubmissionId(AssignmentDto assignmentDto) {
        return apiClient.makeRequest(HttpMethod.GET, "/assignment/getBySubmissionId/" + assignmentDto.getSubmission().getId(), assignmentDto, AssignmentDto.class, AssignmentDto.class);
    }
