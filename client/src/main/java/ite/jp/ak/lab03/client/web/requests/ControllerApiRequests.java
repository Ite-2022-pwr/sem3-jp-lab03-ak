...
public class ControllerApiRequests {
    ...
    public static ControllerDto[] getAllControllers() {
        return apiClient.makeRequest(HttpMethod.GET, "/controller/all", new ControllerDto(), ControllerDto.class, ControllerDto[].class);
    }
